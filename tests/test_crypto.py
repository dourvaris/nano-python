...
SIGNING_TESTS = [
    {
        'private_key': unhexlify(
            'A1A7DF26F28DBCC9AB2FF66431473C5F' 'C7F6DD48CAC1485CD45F3F9D82616802'
        ),
        'public_key': unhexlify(
            '8A3E229B28FFC19DE27C2FD9AFBB6BA' '8723E7E267B87AA690854AB01543E9D20'
        ),
        'message': unhexlify(
            '5904FC0108F37D30AD57AF9A56F54354' '2476425E473F3C0AFC8D44348BDA48C0'
        ),
        'signature': unhexlify(
            '025CA216857868E2094C246104ADBDC8'
...
@pytest.mark.parametrize(
    ...
    [
        (
            unhexlify(
                '9f0e444c69f77a49bd0be89db92c38fe' '713e0963165cca12faf5712d7657120f'
            ),
            unhexlify(
...
@pytest.mark.parametrize(
    'value,expected', [(b'', b'.\'\xc5d}'), (b'\x01$', b'\xa3\x88\xe8#\xe6')]
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                'private': unhexlify(
                    '9f0e444c69f77a49bd0be89db92c38fe'
                    '713e0963165cca12faf5712d7657120f'
                ),
                'public': unhexlify(
                    'c008b814a7d269a1fa3c6528b19201a24'
        ...
        (
            ...
            {
                'private': unhexlify(
                    'b73b723bf7bd042b66ad3332718ba98d'
                    'e7312f95ed3d05a130c9204552a7afff'
                ),
                'public': unhexlify(
                    'e30d22b7935bcc25412fc07427391ab4c'
        ...
        (
            ...
            {
                'private': unhexlify(
                    'DBD5DF42B3D4120A9E8F6D3B2EEDCDC2'
                    '1AD27CF76E95978564F66F44E0240184'
                ),
                'public': unhexlify(
                    '2791D5A1697D454448F9EEABA2A336E52'
        ...
        (
            ...
            {
                'private': unhexlify(
                    '4A6E3512ACBB38A3D6BCF53D5452E11F'
                    '6B34C30D0405139E3328FD7A63E2D612'
                ),
                'public': unhexlify(
                    'E04BC3CAEDAA1787E9373A105453160E4'
...
@pytest.mark.parametrize(
    'message,signature,public_key,error_msg',
    [
